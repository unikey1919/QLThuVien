...
{
    public partial class frmManageStudentUser : Form
    {
        Student student = new Student();
        Account acc = new Account();

        public frmManageStudentUser()
        {
            InitializeComponent();
        ...
        {
            frmShowStudent frmShowStudent = new frmShowStudent();
            frmShowStudent.ShowDialog();

            try
            {
                Student std = new Student();
                string Mathe = frmShowStudent.dtgvStudent.CurrentRow.Cells[0].Value.ToString();
